	...
	return (
		<>
			<Head>
				...
				<meta name="description" content={truncateString(post?.content || '', 200)} />

				<meta property="og:type" content="website" />
				<meta property="og:url" content={`/post/${post?.id}`} />
				<meta property="og:title" content={post?.title} />
				<meta property="og:description" content={truncateString(post?.content || '', 200)} />
				...
				<meta property="twitter:description" content={truncateString(post?.content || '', 200)} />
